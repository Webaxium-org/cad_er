...
const SurveyPurposeSchema = new Schema(
  {
    ...
    bermWidth: Number,
    // Legacy vertical-buffer settings are retained only for reading saved proposals.
    buffer: Number,
    bufferReference: { type: String, enum: ["centerline", "lowest", "referenceRL"] },
    bufferReferenceRL: Number,
    bankLimitsMode: { type: String, enum: ["custom", "surveyWidth"] },
    leftBankOffset: Number,
    rightBankOffset: Number,
